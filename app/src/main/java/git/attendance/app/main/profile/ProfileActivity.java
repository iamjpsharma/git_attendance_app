package git.attendance.app.main.profile;
...
import git.attendance.app.main.database.DatabaseHandler;
import git.attendance.app.main.profile.ProfileAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent launchIntent = new Intent(profileActivity, git.attendance.app.main.profile.StudentRegistration.class);
